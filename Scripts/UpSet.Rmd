...
pdf("upset_plot_common_genes_human_mouse.pdf",  width = 7, height = 5)
upset(fromList(genelist),
      order.by = "freq",
      point.size = 3.5,
      mb.ratio = c(0.55, 0.45),
      text.scale = c(1.5, 1.5, 1.5, 1.25, 1.5, 1.5),
      shade.color = "darkgreen",
      shade.alpha = 0.4,
      matrix.color = "darkslategray",
      main.bar.color = "darkseagreen4",
      sets.bar.color = "lightskyblue4"
      )
dev.off()
```
